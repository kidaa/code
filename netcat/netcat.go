...
func main() {
	...
	var listen bool
	flag.StringVar(&host, "host", "", `-host 127.0.0.1 -port ":6000" -proto "udp"`)
	flag.StringVar(&proto, "proto", "tcp", `-proto "udp"  or -proto "tcp"`)
	flag.BoolVar(&listen, "listen", false, `-port ":6000" -proto "udp" -listen`)
	flag.StringVar(&port, "port", ":9999", `-port ":6000" -proto "udp" -listen`)
	flag.Parse()
